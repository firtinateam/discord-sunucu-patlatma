...
SERVER_CONFIG = {
    ...
    "new_icon": "https://hizliresim.com/9wkz9wz",   # New Server Icon url here → https://image.jpg 
    "new_description": "",  # New Server Description here 
}

WEBHOOK_CONFIG = {
    "default_name": "discord.gg/firtinateam",  # Webhook Name here 
}
...
BOT_PRESENCE = {
    ...
    "text": "discord.gg/firtinateam"  # Your text presence
}
